...
export default class ClusteredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_lightbuffer', 'u_clusterbuffer', 'u_viewMatrix', 'u_near', 'u_far', 'u_screenSize', 'u_viewProjMatInv', 'u_camPos'],
      attribs: ['a_uv'],
    });
  ...
  render(camera, scene) {
    ...
    let tmp = mat4.create();
    mat4.invert(tmp, this._viewProjectionMatrix);
    gl.uniformMatrix4fv(this._progShade.u_viewProjMatInv, false, tmp);
    gl.uniform2f(this._progShade.u_screenSize, canvas.width, canvas.height);
