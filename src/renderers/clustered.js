...
export default class ClusteredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_gbuffers[2]', 'u_gbuffers[3]', 'u_lightbuffer', 'u_clusterbuffer', 'u_farClip', 'u_nearClip', 'u_nearWidth', 'u_farWidth', 'u_nearHeight', 'u_farHeight', 'u_xSlices', 'u_ySlices', 'u_zSlices', 'u_viewMatrix', 'u_eyePos'],
      attribs: ['a_uv'],
    });
  ...
  render(camera, scene) {
    ...
    gl.uniform1f(this._progShade.u_nearWidth, this.viewNearW);
    gl.uniform1f(this._progShade.u_nearHeight, this.viewNearH);

    gl.uniform1f(this._progShade.u_farWidth, this.viewFarW);
    gl.uniform1f(this._progShade.u_farHeight, this.viewFarH);
