...
// Added g buffers for differed rendering (normals and albedo)
...
export default class ClusteredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_gbuffers[2]', 'u_gbuffers[3]', 'u_modelViewMatrix', 'u_lightbuffer', 
                 'u_clusterbuffer', 'u_nearClip', 'u_nearWidth', 'u_nearHeight', 'u_farClip', 'u_farWidth', 'u_farHeight', 
                 'u_eyePos', 'u_xSlices', 'u_ySlices', 'u_zSlices'],
      attribs: ['a_uv'],
    });
